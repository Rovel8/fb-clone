...
import defaultProfilePicture from '../../../../../assets/default-avatar-profile-icon-vector-social-media-user-image-182145777.jpg'
...
export const TextInput: React.FC<{}> = () => {
    ...
    const profilePicture = picture ? picture : defaultProfilePicture
            ...
            <Formik onSubmit={onSubmit} initialValues={initialValues}>
                <Form className={classes.InputWrapperForm}>
                    <div className={classes.TextInputField}>
                        <Field as={CustomInput} name={'text'} id={'text'} placeholder={"What's on your mind"}
                               type={'text'}/>
                    </div>
